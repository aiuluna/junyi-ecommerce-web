  ...
  http_util.request('queen', '/product/summary/list/' + config.skuIds.join(','))
    .done(
      http_util.resultMessageHandler(function(products) {
        common_util.renderEx(req, res, 'article/temporary', {
...
var articleConfigs = {
  'article_1': {
    'title': '冬季肌肤大改造',
    'bannerImageUrl': '201603/0illprngq5r4l_1920x350.jpg',
    'skuIds': [410, 375, 604, 184, 180, 15, 53, 7, 78, 141, 142]
  },
  'article_2': {
    'title': '限量特卖',
    'bannerImageUrl': '201603/0illprnmibm3d_1920x350.jpg',
    'skuIds': [664, 843, 669, 175, 691, 37, 652, 137, 25, 687, 184, 271, 268, 278]
  },
  'article_3': {
    'title': '免税专场',
    'bannerImageUrl': '201604/0imsthfs9zl1k_1920x350.jpg',
    'skuIds': [10, 16, 21, 29, 47, 72, 77, 81, 105, 107, 152, 155, 159, 181, 186, 192, 196, 519, 520, 582]
  },
  'article_4': {
    'title': '奶粉免税专场',
    'bannerImageUrl': '201604/0imwu1kd5xdg9_1920x350.jpg',
